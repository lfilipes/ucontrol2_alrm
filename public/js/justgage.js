...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#045681"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#045681"),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#E53A0F"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#045681"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#a9d70b", "#f9c802", "#008100"], 'array', ','),
    ...
    titleMinFontSize: kvLookup('titleMinFontSize', config, dataset, 14),

    // labelMinFontSize
    // absolute minimum font size for the label
    labelMinFontSize: kvLookup('labelMinFontSize', config, dataset, 14),

    // minLabelMinFontSize
    // absolute minimum font size for the minimum label
    minLabelMinFontSize: kvLookup('minLabelMinFontSize', config, dataset, 14),

    // maxLabelMinFontSize
    // absolute minimum font size for the maximum label
    maxLabelMinFontSize: kvLookup('maxLabelMinFontSize', config, dataset, 14),
